...
/*   Updated: 2026/08/28 06:45:20 by casampai, f      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    // Zerar completamente a struct evita valores lixo na memoria
    ft_memset(&current_context, 0, sizeof(t_current_context));
    ft_memset(&count, 0, sizeof(t_count_operations));
    ...
    // CALCULAR O DISORDER AQUI (Com os numeros desordenados)
