...
/*   Updated: 2026/08/28 06:50:32 by casampai, f      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    int top = (context->stack_a)->value;
    int mid = (context->stack_a)->next->value;
    int bot = (context->stack_a)->next->next->value;

    if (top > mid && mid < bot && top < bot)
        sa(context);
    else if (top > mid && mid > bot)
        { sa(context); rra(context); }
    else if (top > mid && mid < bot && top > bot)
        ra(context);
    else if (top < mid && mid > bot && top < bot)
        { sa(context); ra(context); }
    else if (top < mid && mid > bot && top > bot)
        rra(context);
}
